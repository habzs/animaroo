...
?>
    ...
    <div class="breadcrumb_inset">
                    ...
                    <span class="navigation-pipe">&gt;</span> 
                            <span class="navigation_page">Cat</span>
                    </div>
        </div>
                        <div class="row">
                                                                                                            <!-- Left -->
                ...
                <!--<div class="titled_box" id="subcategories">
                    ...
                    <!--<ul class="row">
                      ...
                      <a title="Treats" class="lnk_more_sub" href="#"><i class="icon-caret-right "></i> Treats</a>
                            ...
                            <a title="Cat Litter" href="#">
                                                            <img alt="" src="#">
                                                    
                            </a>
                      <a title="Cat Litter" class="lnk_more_sub" href="#"><i class="icon-caret-right "></i> Cat Litter</a>
                        </li>
...
<li class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 num-1 alpha  first_item_of_tablet_line ">            
    <div class="inner_content clearfix">
        <a title="Addiction Cat Salmon Bleu – Grain Free" class="product_img_link" href="#">
                    <img alt="Addiction Cat Salmon Bleu – Grain Free" src="https://www.beary.com.sg/28-home_default/addiction-cat-salmon-bleu-grain-free.jpg">
                </a>
...
<li class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 num-2  last_item_of_tablet_line ">
            <div class="inner_content clearfix">
                ...
                <div class="center_block">
                    ...
                    <div class="clear"></div>
                    <h5>
                                        <a title="Fussie Cat Crystal Litter" class="product_link" href="#">Fussie Cat Crystal Litter</a></h5>
...
<li class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 num-3 omega  first_item_of_tablet_line ">
            <div class="inner_content clearfix">
                ...
                <div class="center_block">
                    ...
                    <div class="clear"></div>
                    <h5>
                                        <a title="Ciao Churu Tuna (Maguro)" class="product_link" href="#">Ciao Churu Tuna (Maguro)</a></h5>
...
<li class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 num-4 alpha  last_item_of_tablet_line ">
            <div class="inner_content clearfix">
                ...
                <div class="center_block">
                    ...
                    <div class="clear"></div>
                    <h5>
                                        <a title="Ciao Churu Skipjack (Katsuo)" class="product_link" href="#">Ciao Churu Skipjack (Katsuo)</a></h5>
...
<li class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 num-5  first_item_of_tablet_line ">
            <div class="inner_content clearfix">
                ...
                <div class="center_block">
                    ...
                    <div class="clear"></div>
                    <h5>
                                        <a title="Ciao Churu Tuna with Collagen" class="product_link" href="#">Ciao Churu Tuna with Collagen</a></h5>
...
<li class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 num-8  last_item_of_tablet_line ">
            <div class="inner_content clearfix">
                ...
                <div class="center_block">
                    ...
                    <div class="clear"></div>
                    <h5>
                                        <a title="Canada Cat Litter - Lavender" class="product_link" href="#">Canada Cat Litter - Lavender</a></h5>
...
<li class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 num-9 omega  first_item_of_tablet_line ">
            <div class="inner_content clearfix">
                ...
                <div class="center_block">
                    ...
                    <div class="clear"></div>
                    <h5>
                                        <a title="Nurture Pro Tofu Cat Litter - Original" class="product_link" href="#">Nurture Pro Tofu Cat Litter - Original</a></h5>
