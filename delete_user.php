						...
						<div class="animate-box">
							<h3>Your Account.</h3>
								<p>
									...
									<h3><div style="color:red;text-align:center;"> User has been DELETED. </div></h3>
									<h2><div style="text-align:center;"><a class="btn btn-lg btn-primary centered" href="registered_users.php">Back</a></div></h2>
						</div>
					</div>
				...
				<div class="animate-box">
					<h3>Your Account.</h3>
						<p>
							...
							<h3><div style="color:red;text-align:center;"> User has NOT been deleted. </div></h3>
							<h2><div style="text-align:center;"><a class="btn btn-lg btn-primary centered" href="registered_users.php">Back</a></div></h2>
				</div>
			</div>
