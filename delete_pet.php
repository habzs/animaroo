...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($_POST['sure'] == 'Yes') { // Delete the record.
		...
		// Make the query:
		$q = "DELETE FROM pets WHERE id=$id LIMIT 1";		
		...
		if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
						...
						<div class="animate-box">
							<h3>Your Account.</h3>
								<p>
									...
									<h3><div style="color:red;text-align:center;"> Your pet has been DELETED. </div></h3>
									<h2><div style="text-align:center;"><a class="btn btn-lg btn-primary centered" href="my_pets.php">Back</a></div></h2>
						</div>
					</div>
			...
			echo '<p class="error">The pet could not be deleted due to a system error.</p>'; // Public message.
				...
				<div class="animate-box">
					<h3>Your Account.</h3>
						<p>
							...
							<h3><div style="color:red;text-align:center;"> Your pet has NOT been deleted. </div></h3>
							<h2><div style="text-align:center;"><a class="btn btn-lg btn-primary centered" href="my_pets.php">Back</a></div></h2>
				</div>
			</div>
	...
	$q = "SELECT petname FROM pets WHERE id=$id";
	$r = @mysqli_query ($dbc, $q);
